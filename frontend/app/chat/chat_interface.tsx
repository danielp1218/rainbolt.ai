...
export default function ChatInterface() {
    ...
    return (
        <div className="relative h-screen w-screen overflow-hidden bg-black">
            ...
            <div className="absolute inset-0 right-[0px]">
                <EarthScene markers={[]} currentSection={0} />
            ...
            <div className="absolute top-0 right-0 bottom-0 w-[600px] flex flex-col bg-black/95 border-l border-white/50 shadow-3xl">
